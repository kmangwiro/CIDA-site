  ...
  return (
      <footer className="border-t border-border bg-foreground py-16">
        <div className="mx-auto max-w-7xl px-6">
          ...
          {/* Bottom Bar */}
          <div className="mt-12 border-t border-background/10 pt-8 text-center text-xs text-background/40 space-y-2">
            <div>
            ...
            <div>
              ...
              <Link
                  ...
                  className="text-background/70 hover:text-primary font-semibold underline"
              >
                AstroCode
              </Link>
            </div>
